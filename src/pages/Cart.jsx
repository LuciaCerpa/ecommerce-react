            ...
            <section>
              <Container>
                <Row>
                  ...
                  {
                    cartItems.length === 0 ? (
                      <h2 className='fs-4 text-center'>No item has been added to cart</h2> 
                    ) : (
...
const Tr = ({item}) => {
  ...
  <td>${item.price}</td>
  <td><button className='cart__buttons' onClick={decrement}> - </button>{item.quantity}px <button className='cart__buttons' onClick={increment}> + </button></td>
  <td>
    <motion.i 
